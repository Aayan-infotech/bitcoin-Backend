...
const { createQuiz,getQuizById,getAllQuizzes, removeQuestionFromQuiz, submitQuizAnswers} = require('../../controllers/QuizRelated/QuizController')
...
const { startQuiz } = require('../../controllers/QuizRelated/quizProgress');
